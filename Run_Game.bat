...
:: ============================================================================
:: Operation Storm - Windows Launcher (Play Mode)
:: ============================================================================
...
:: Check if project assets have been imported (first-time setup)
if not exist "%ROOT%.godot\imported" (
    echo First-time setup: importing project assets...
    "%GODOT_EXE%" --headless --editor --quit-after 2 --path "%ROOT%." >nul 2>&1
)
